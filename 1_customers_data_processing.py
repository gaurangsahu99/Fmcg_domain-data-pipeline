...
base_path=f's3://sportsbar-1999/{data_source}/*.csv'
print(base_path)
...
df=(
    ...
    .load(base_path)
    .withColumn("read_timestamp",F.current_date())
...
display(df_silver.filter(df_silver.customer_id == "789520"))
...
#Business confirmation Note: City corrections by business team
customer_city_fix={
    #sprintx Nutrition
    789403:"New Delhi",
